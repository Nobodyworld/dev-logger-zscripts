...
- [x] (2025-01-27 19:15Z) Updated README/CONTRIBUTING, recorded ADR 20250127, and appended STATUS.md summary.
...
Finally, document the new workflow in README/CONTRIBUTING and append a STATUS.md entry summarizing the PR. Capture the security tooling adoption in a new ADR (`docs/adr/YYYYMMDD-supply-chain-hardening.md`). Ensure validation instructions cover `make sbom`, `pre-commit run --all-files`, `pytest`, and `mypy`.
...
5. Update STATUS.md with summary and next steps.
