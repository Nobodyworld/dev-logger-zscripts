...
- Next: implement typing cleanups and module decomposition per PLAN.md Milestone 2.
...
- Next: continue Milestone 2 by decomposing `zscripts/utils.py` into focused modules and introducing structured logging/metrics per PLAN.md.
