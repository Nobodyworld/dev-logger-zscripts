...
Refer to `docs/guides/EXTENSION_GUIDE.md` for hands-on steps to create a new extension using
`python cli.py extensions scaffold` or the richer
`scripts/scaffold_module.py extension` workflow, and `docs/automation/AUTOMATION.md` for
