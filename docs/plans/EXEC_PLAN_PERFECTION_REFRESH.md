...
- Documentation (`README.md`, `docs/plans/PROJECT_STATUS_REPORT.md`) does not mention environment overrides, new CLI options, or ignore semantics.
...
5. Refresh `README.md`, `docs/plans/PROJECT_STATUS_REPORT.md`, and `CHANGELOG.md` to document enhancements.
