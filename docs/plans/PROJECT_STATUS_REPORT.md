...
- **Command**: `python -m zscripts collect --types python --project-root examples/sample_project`
...
- **Command**: `python -m zscripts consolidate --types python --project-root examples/sample_project`
...
- **Command**: `python -m zscripts tree --project-root examples/sample_project`
...
- **Config File**: `configs/zscripts.config.json` (JSON format)
- **Key Settings**:
...
- **CI Integration**: Pipeline example in `examples/sample_project/infra/pipeline.yaml`
