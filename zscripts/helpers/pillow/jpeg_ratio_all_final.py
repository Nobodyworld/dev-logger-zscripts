...
edit_these_folder = str(org_path("Revenue Streams", "images_process", "c.completed_image_ratios"))
processed_folder = str(org_path("Revenue Streams", "images_process", "d.ready_to_post"))
product_name = "WildFlowers_DGP"
        ...
        try:
            ...
            for size, (width, height) in aspect_ratios:
                ...
                try:
                    ...
                    dpi = (300, 300)
                    img_resized.save(
                        os.path.join(file_folder, new_filename), format="JPEG", quality=95, dpi=dpi
                    )
